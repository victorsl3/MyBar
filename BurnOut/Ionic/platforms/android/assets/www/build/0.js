webpackJsonp([0],Array(450).concat([
/* 450 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(579);
...
var string = __webpack_require__(585);
...
/* MIT license */
var cssKeywords = __webpack_require__(460);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(457)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chart_js__ = __webpack_require__(580);
...
var DashboardPage = (function () {
    function DashboardPage(navCtrl, global) {
    ...
    DashboardPage.prototype.calcularDatosGraficas = function () {
        if (this.resultadoPreguntas.ae > 26 && this.resultadoPreguntas.d > 9 && this.resultadoPreguntas.rp < 34) {
            this.porcentajeBurnout = Math.round(((this.resultadoPreguntas.ae + this.resultadoPreguntas.d - this.resultadoPreguntas.rp) * 100) / 84);
        }
        else {
            this.porcentajeBurnout = 0;
        }
    ...
    /* GRAFICAS */
    DashboardPage.prototype.graficas = function () {
        this.graficaBurnoutChart = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"](this.graficaBurnout.nativeElement, {
            type: 'doughnut',
            data: {
                datasets: [{
        ...
        this.graficaAEChart = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"](this.graficaAE.nativeElement, {
            type: 'doughnut',
            data: {
                datasets: [{
        ...
        this.graficaDChart = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"](this.graficaD.nativeElement, {
            type: 'doughnut',
            data: {
                datasets: [{
        ...
        this.graficaRPChart = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"](this.graficaRP.nativeElement, {
            type: 'doughnut',
            data: {
                datasets: [{
    ...
    /* FIN GRAFICAS */
    /* ACTUALIZAR GRAFICAS */
    DashboardPage.prototype.actualizarGraficas = function () {
        this.calcularDatosGraficas();
    ...
    /* ACTUALIZAR GRAFICAS */
    /* ATRAS */
    DashboardPage.prototype.atras = function () {
    ...
    /* FIN ATRAS */
    /* SIGUIENTE */
    DashboardPage.prototype.siguiente = function () {
        if (this.indice > 0) {
            this.indice--;
            this.resultadoPreguntas = this.global.resultadosPreguntas[(this.global.resultadosPreguntas.length - 1) - this.indice];
            this.actualizarGraficas();
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('graficaBurnout'),
        __metadata("design:type", Object)
    ], DashboardPage.prototype, "graficaBurnout", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('graficaAE'),
        __metadata("design:type", Object)
    ], DashboardPage.prototype, "graficaAE", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('graficaD'),
        __metadata("design:type", Object)
    ], DashboardPage.prototype, "graficaD", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('graficaRP'),
        __metadata("design:type", Object)
    ], DashboardPage.prototype, "graficaRP", void 0);
    DashboardPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-dashboard',template:/*ion-inline-start:"D:\Trabajo\Clientes\Christian Sukuzhanay\Proyectos\eburout\Codigo\eburnout\src\pages\dashboard\dashboard.html"*/'<!-->HEADER</!-->\n<ion-header>\n  <div>\n    <ion-navbar>\n      <ion-title>Dashboard</ion-title>\n    </ion-navbar>\n  </div>\n</ion-header>\n<!-->FIN HEADER</!-->\n\n<!-->CONTENT</!-->\n<ion-content padding>\n  <ion-grid class="grid-graficos-peque">\n    <ion-row>\n      <ion-col class="col-flecha">\n        <ion-icon *ngIf="indice < global.resultadosPreguntas.length - 1" (click)="atras()" name="ios-arrow-back"></ion-icon>\n      </ion-col>\n      <ion-col>\n        <div class="bloque-grafico-burnout">\n          <div class="grafico-burnout">\n            <canvas #graficaBurnout></canvas>\n            <div class="icono">\n              <ion-icon name="flame"></ion-icon>\n            </div>\n          </div>\n          <p>BURNOUT\n            <span [ngClass]="{\'color-porcentaje\' : porcentajeBurnout > 0 }" class="porcentaje">{{ porcentajeBurnout }}%</span>\n          </p>\n        </div>\n      </ion-col>\n      <ion-col class="col-flecha">\n        <ion-icon *ngIf="indice > 0" (click)="siguiente()" name="ios-arrow-forward"></ion-icon>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-grid class="grid-graficos-peque">\n    <ion-row>\n      <ion-col>\n        <div class="grafico-peque">\n          <canvas #graficaAE></canvas>\n          <div class="icono">\n            <ion-icon name="battery-charging"></ion-icon>\n          </div>\n        </div>\n      </ion-col>\n      <ion-col>\n        <div class="grafico-peque">\n          <canvas #graficaD></canvas>\n          <div class="icono">\n            <ion-icon name="body"></ion-icon>\n          </div>\n        </div>\n      </ion-col>\n      <ion-col>\n        <div class="grafico-peque">\n          <canvas #graficaRP></canvas>\n          <div class="icono">\n            <ion-icon name="build"></ion-icon>\n          </div>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <div class="bloque-btn-detalles">\n    <div (click)="detalles ? detalles = false : detalles = true;" class="btn-detalles">\n      <p class="detalles">Ver más</p>\n      <ion-icon [hidden]="detalles" name="ios-arrow-down"></ion-icon>\n      <ion-icon [hidden]="!detalles" name="ios-arrow-up"></ion-icon>\n    </div>\n  </div>\n  <ion-grid [hidden]="!detalles" class="grid-leyenda">\n    <ion-row>\n      <ion-col class="col-icon">\n        <ion-icon name="battery-charging"></ion-icon>\n      </ion-col>\n      <ion-col col-auto class="col-texto">\n        <p>CANSANCIO EMOCIONAL</p>\n      </ion-col>\n      <ion-col class="col-porcentaje">\n        <p [ngClass]="{\'color-porcentaje\' : porcentajeAE > 0 }">{{ porcentajeAE }}%</p>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col class="col-icon">\n        <ion-icon name="body"></ion-icon>\n      </ion-col>\n      <ion-col col-auto class="col-texto">\n        <p>DESPERSONALIZACIÓN</p>\n      </ion-col>\n      <ion-col class="col-porcentaje">\n        <p [ngClass]="{\'color-porcentaje\' : porcentajeD > 0 }">{{ porcentajeD }}%</p>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col class="col-icon">\n        <ion-icon name="build"></ion-icon>\n      </ion-col>\n      <ion-col col-auto class="col-texto">\n        <p>REALIZACIÓN PERSONAL</p>\n      </ion-col>\n      <ion-col class="col-porcentaje">\n        <p [ngClass]="{\'color-porcentaje\' : porcentajeRP > 0 }">{{ porcentajeRP }}%</p>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n<!-->FIN CONTENT</!-->'/*ion-inline-end:"D:\Trabajo\Clientes\Christian Sukuzhanay\Proyectos\eburout\Codigo\eburnout\src\pages\dashboard\dashboard.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_global_global__["a" /* GlobalProvider */]])
    ], DashboardPage);
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(581)();
...
var color = __webpack_require__(458);
...
var conversions = __webpack_require__(459);
var route = __webpack_require__(584);
...
var implementation = __webpack_require__(587);
...
var moment = __webpack_require__(457);
